								 ...
								 c =cimpl.getCustomerById(ci);
									...
									if(c!=null) {
										...
										System.out.println("\n\n********Welcome to update page of the Customer Details******\n\n"
											...
											System.out.println("Enter 2---> update name");
											System.out.println("Enter 3---> update Password");
											System.out.println("Enter 4---> update Phone");
											System.out.println("Enter 5---> update account balance");
...
//													System.out.println("Error while updating customer name!!");
												...
												int count=dao.NameChange(res, pwd,newName);
