...
public class bankingmain {
	...
	public static void main(String[] args)throws Exception {
		...
		//creating new account
			...
			System.out.print("Enter Cutstomer bankID");
			String bankID=bs.next();
			...
			b1 = new bankingcustomer(cId,cName,cpwd,cphone,caccbal,bankID);
			...
			if(res==0) {
				...
				while(flag) {
					...
					case 1->{
						...
						System.out.println("Withdraw processing... "+amt);
